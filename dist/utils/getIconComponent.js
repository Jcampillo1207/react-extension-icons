...
var getIconComponent = function (extension, variant) {
    if (variant === void 0) { variant = 'color'; }
    var ext = extensionMapping[extension.toLowerCase()] || extension.toLowerCase();
    var iconVariants = icons[ext];
