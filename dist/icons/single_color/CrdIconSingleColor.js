...
function CrdIconSingleColor(props) {
    return React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 200 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2_2515)" },
            ...
            React.createElement("path", { d: "M82.5198 62C82.5198 62 106 67 84.2498 140.49H81.2498C81.2498 140.49 60.3498 72.8 82.5198 62Z", fill: props.color || "#4690FF" }),
            React.createElement("path", { d: "M87.7098 62.7197C87.7098 62.7197 120.55 75.1098 86.1298 140.06C86.1298 140.06 138.12 76.6897 87.7098 62.7197Z", fill: props.color || "#4690FF" }),
            React.createElement("path", { d: "M101.39 67.1899C101.39 67.1899 132.93 82.88 90.1598 137.61C90.1598 137.61 139.27 84.7599 101.39 67.1899Z", fill: props.color || "#4690FF" }),
            React.createElement("path", { d: "M77.8598 62.7197C77.8598 62.7197 45.0198 75.1098 79.4398 140.06C79.4398 140.06 27.4498 76.6897 77.8598 62.7197Z", fill: props.color || "#4690FF" }),
            React.createElement("path", { d: "M64.1798 67.1899C64.1798 67.1899 32.6398 82.88 75.4098 137.61C75.4098 137.61 26.2998 84.7599 64.1798 67.1899Z", fill: props.color || "#4690FF" }),
            React.createElement("path", { d: "M87.1898 154.03H78.7298L76.1898 145.96H89.7298L87.1898 154.03Z", fill: props.color || "#4690FF" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_2_2515" },
                React.createElement("rect", { width: "1em", height: "1em", fill: "white", transform: "translate(0.569824)" }))));
}
exports.default = CrdIconSingleColor;
