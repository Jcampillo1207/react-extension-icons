...
function BmpIconColor(props) {
    return React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 201 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2_550)" },
            ...
            React.createElement("path", { d: "M165.28 49.24H140.53C135.061 49.2373 129.817 47.0644 125.949 43.1982C122.081 39.3321 119.905 34.0889 119.9 28.62V0L165.28 49.24Z", fill: "#A140FF" }),
            React.createElement("path", { d: "M184.8 170.6H59.76C50.8903 170.6 43.7 177.79 43.7 186.66V223.94C43.7 232.81 50.8903 240 59.76 240H184.8C193.67 240 200.86 232.81 200.86 223.94V186.66C200.86 177.79 193.67 170.6 184.8 170.6Z", fill: "#A140FF" }),
            React.createElement("path", { d: "M79.46 213.37V220.65H71.9299V213.37H79.46Z", fill: "white" }),
            React.createElement("path", { d: "M105.6 207.8C106.655 209.114 107.217 210.755 107.19 212.44C107.242 213.569 107.038 214.696 106.593 215.735C106.148 216.774 105.473 217.699 104.62 218.44C102.9 219.88 100.44 220.61 97.24 220.61H83.24V190.54H96.8899C99.9499 190.54 102.317 191.207 103.99 192.54C104.827 193.226 105.49 194.1 105.926 195.09C106.362 196.08 106.559 197.16 106.5 198.24C106.563 199.872 106.054 201.474 105.06 202.77C104.108 203.972 102.769 204.806 101.27 205.13C102.977 205.498 104.505 206.44 105.6 207.8ZM90.52 202.87H95.28C97.8067 202.87 99.0701 201.79 99.0701 199.63C99.0701 197.47 97.78 196.393 95.2 196.4H90.52V202.87ZM99.75 211.42C99.7733 210.946 99.6903 210.473 99.5068 210.035C99.3234 209.597 99.0442 209.206 98.6899 208.89C97.8327 208.233 96.7679 207.907 95.6899 207.97H90.54V214.73H95.73C98.41 214.73 99.75 213.627 99.75 211.42Z", fill: "white" }),
