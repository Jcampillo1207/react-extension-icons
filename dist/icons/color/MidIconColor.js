...
function MidIconColor(props) {
    return React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 201 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2_560)" },
            ...
            React.createElement("path", { d: "M164.57 49.24H139.81C134.343 49.2347 129.101 47.0606 125.235 43.1947C121.369 39.3288 119.195 34.0871 119.19 28.62V0L164.57 49.24Z", fill: "#005FAD" }),
            React.createElement("path", { d: "M184.09 170.6H59.05C50.1803 170.6 42.99 177.79 42.99 186.66V223.94C42.99 232.81 50.1803 240 59.05 240H184.09C192.96 240 200.15 232.81 200.15 223.94V186.66C200.15 177.79 192.96 170.6 184.09 170.6Z", fill: "#005FAD" }),
            React.createElement("path", { d: "M83.48 213.37V220.64H76V213.37H83.48Z", fill: "white" }),
            React.createElement("path", { d: "M121.08 190.78V220.64H113.8V202L107.34 220.67H101L94.5 201.96V220.67H87.22V190.81H96.11L104.24 211.61L112.24 190.81L121.08 190.78Z", fill: "white" }),
            React.createElement("path", { d: "M133.37 190.57V220.64H126.1V190.57H133.37Z", fill: "white" }),
            React.createElement("path", { d: "M163.54 213.39C162.288 215.664 160.397 217.52 158.1 218.73C155.516 220.053 152.642 220.71 149.74 220.64H138.39V190.57H149.74C152.645 190.492 155.524 191.134 158.12 192.44C160.41 193.624 162.297 195.462 163.54 197.72C164.842 200.117 165.497 202.813 165.44 205.54C165.494 208.277 164.84 210.981 163.54 213.39ZM155.72 211.88C156.533 211.046 157.163 210.051 157.569 208.959C157.975 207.867 158.149 206.703 158.08 205.54C158.149 204.377 157.975 203.213 157.568 202.121C157.162 201.03 156.532 200.035 155.72 199.2C153.894 197.61 151.516 196.802 149.1 196.95H145.66V214.13H149.1C151.516 214.278 153.894 213.47 155.72 211.88Z", fill: "white" }),
            ...
            React.createElement("path", { d: "M107.39 144.9C114.559 144.9 120.37 139.089 120.37 131.92C120.37 124.751 114.559 118.94 107.39 118.94C100.221 118.94 94.4099 124.751 94.4099 131.92C94.4099 139.089 100.221 144.9 107.39 144.9Z", fill: "#005FAD" }),
            React.createElement("path", { d: "M57.3201 144.9C64.4887 144.9 70.3 139.089 70.3 131.92C70.3 124.751 64.4887 118.94 57.3201 118.94C50.1514 118.94 44.3401 124.751 44.3401 131.92C44.3401 139.089 50.1514 144.9 57.3201 144.9Z", fill: "#005FAD" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_2_560" },
