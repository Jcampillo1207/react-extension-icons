...
function EpsIconGrayscale(props) {
    return React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 200 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2_1983)" },
            ...
            React.createElement("path", { d: "M123.74 127.73H121.25C121.237 117.638 117.221 107.964 110.084 100.829C102.947 93.6937 93.2719 89.6807 83.1801 89.6702C73.0892 89.6808 63.4145 93.694 56.2792 100.829C49.1438 107.965 45.1306 117.639 45.12 127.73H42.63C42.6432 116.98 46.9198 106.673 54.5215 99.0715C62.1232 91.4698 72.4296 87.1934 83.1801 87.1802C93.9323 87.1908 104.241 91.466 111.845 99.068C119.449 106.67 123.727 116.978 123.74 127.73Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M140.81 87.1802H25.55V89.6702H140.81V87.1802Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M47.86 123.75H39.89V131.72H47.86V123.75Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M126.48 123.75H118.51V131.72H126.48V123.75Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M87.17 84.3101H79.2V92.28H87.17V84.3101Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M25.42 92.29C27.6237 92.29 29.41 90.5037 29.41 88.3C29.41 86.0964 27.6237 84.3101 25.42 84.3101C23.2164 84.3101 21.4301 86.0964 21.4301 88.3C21.4301 90.5037 23.2164 92.29 25.42 92.29Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M140.43 92.29C142.634 92.29 144.42 90.5037 144.42 88.3C144.42 86.0964 142.634 84.3101 140.43 84.3101C138.226 84.3101 136.44 86.0964 136.44 88.3C136.44 90.5037 138.226 92.29 140.43 92.29Z", fill: "#5B5B5B" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_2_1983" },
                React.createElement("rect", { width: 200.01, height: 240, fill: "white", transform: "translate(0.709961)" }))));
}
exports.default = EpsIconGrayscale;
