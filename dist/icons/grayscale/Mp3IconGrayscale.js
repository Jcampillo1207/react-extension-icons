...
function Mp3IconGrayscale(props) {
    return React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 200 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2_2172)" },
            ...
            React.createElement("path", { d: "M184.51 170.6H59.4698C50.6002 170.6 43.4099 177.79 43.4099 186.659V223.939C43.4099 232.809 50.6002 240 59.4698 240H184.51C193.38 240 200.57 232.809 200.57 223.939V186.659C200.57 177.79 193.38 170.6 184.51 170.6Z", fill: "#5B5B5B" }),
            ...
            React.createElement("path", { d: "M120.8 131.92H109.85V87.6596C109.85 86.1771 109.261 84.7552 108.213 83.7069C107.164 82.6586 105.742 82.0696 104.26 82.0696H76.2598C75.5257 82.0696 74.7988 82.2142 74.1206 82.4951C73.4424 82.776 72.8261 83.1878 72.3071 83.7069C71.788 84.226 71.3763 84.8422 71.0953 85.5204C70.8144 86.1986 70.6698 86.9255 70.6698 87.6596V131.92H59.6698V83.9196C59.6698 82.2352 60.0018 80.5673 60.6467 79.0113C61.2916 77.4552 62.2367 76.0415 63.4282 74.851C64.6197 73.6604 66.0342 72.7163 67.5908 72.0726C69.1473 71.4289 70.8154 71.0983 72.4998 71.0996H108C111.4 71.0996 114.661 72.4503 117.065 74.8545C119.469 77.2587 120.82 80.5195 120.82 83.9196L120.8 131.92Z", fill: "#5B5B5B" }),
            React.createElement("path", { d: "M107.82 144.899C114.988 144.899 120.8 139.088 120.8 131.919C120.8 124.751 114.988 118.939 107.82 118.939C100.651 118.939 94.8398 124.751 94.8398 131.919C94.8398 139.088 100.651 144.899 107.82 144.899Z", fill: "#5B5B5B" }),
